...
'ORBTL.EXE': OrderedDict([
    ...
    (b'S[o]ry[u]', b'\xf2\xa8'),
    (b'Moonlight', b'\xf2\xb2'),
    (b'Longevity', b'\xf2\xbc'),
    (b'Furyquake', b'\xf2\xc6'),
    (b'defenses', b'\xf2\xd0'),
    (b'darkness', b'\xf2\xd9'),
    (b'Training', b'\xf2\xe2'),
    (b'Strength', b'\xf2\xeb'),
    (b'Masamune', b'\xf2\xf4'),
    (b'Judgment', b'\xf2\xfd'),
    (b'Hellfire', b'\xf3\x06'),
    (b'Headband', b'\xf3\x0f'),
    (b'Samurai', b'\xf3\x18'),
    (b'Leather', b'\xf3 '),
    (b'Induces', b'\xf3('),
    (b'Icicles', b'\xf30'),
