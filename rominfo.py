...
'ORFIELD.EXE': OrderedDict([
    ...
    (b'^Gold', b'\xf0\x98'),
    (b'Gold', b'\xf0\x99'),
    (b'^Tanegashima', b'\xf0\x9e'),
    (b'Tanegashima', b'\xf0\x9f'),
    (b'Containing', b'\xf0\xab'),
    (b'Through', b'\xf0\xb6'),
    (b'Spells', b'\xf0\xbe'),
    (b'^Tachi', b'\xf0\xc5'),
    (b'Tachi', b'\xf0\xc6'),
...
'ORBTL.EXE': OrderedDict([
    ...
    (b'Holy', b'\xf0\x89'),
    (b'Frog', b'\xf0\x8e'),
    (b'supernatural', b'\xf0\x93'),
    (b'Tanegashima', b'\xf0\xa0'),
    (b'protection', b'\xf0\xac'),
    (b'element', b'\xf0\xb7'),
    (b'Missive', b'\xf0\xbf'),
    (b'Hanging', b'\xf0\xc7'),
    (b'Blesses', b'\xf0\xcf'),
